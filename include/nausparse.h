...
extern int targetcell_sg(graph*,int*,int*,int,int,_Boolean,int,int,int);
extern _Boolean cheapautom_sg(int*,int,_Boolean,int);
extern _Boolean isautom_sg(graph*,int*,_Boolean,int,int);
...
extern _Boolean aresame_sg(sparsegraph*,sparsegraph*);
extern void put_sg(FILE*,sparsegraph*,_Boolean,int);
...
extern void
   adjacencies_sg(graph*,int*,int*,int,int,int,int*,int,_Boolean,int,int);
extern void
   distances_sg(graph*,int*,int*,int,int,int,int*,int,_Boolean,int,int);
extern void
   distances_sg(graph*,int*,int*,int,int,int,int*,int,_Boolean,int,int);
