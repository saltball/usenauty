...
extern FILE *opengraphfile(char*,int*,_Boolean,long);
...
extern graph *readgg(FILE*,graph*,int,int*,int*,_Boolean*);
extern graph *readg(FILE*,graph*,int,int*,int*);
extern graph *readgg_inc(FILE*,graph*,int,int*,int*,graph*,int,int,_Boolean*);
...
extern sparsegraph *read_sgg_loops(FILE*,sparsegraph*,int*,_Boolean*);
...
extern _Boolean strhaschar(char*,int);

extern void fcanonise(graph*,int,int,graph*,char*,_Boolean);
extern void fcanonise_inv
             (graph*,int,int,graph*,char*,void(*)(graph*,int*,int*,int,
               int,int,int*,int,_Boolean,int,int),int,int,int,_Boolean);
extern void fcanonise_inv_sg
           (sparsegraph*,int,int,sparsegraph*,char*,void(*)(graph*,int*,int*,
             int,int,int,int*,int,_Boolean,int,int),int,int,int,_Boolean);
...
extern void fgroup_inv
	     (graph*,int,int,char*,int*,int*,void(*)(graph*,int*,int*,int,
                int,int,int*,int,_Boolean,int,int),int,int,int);
...
extern TLS_ATTR _Boolean is_pipe;
