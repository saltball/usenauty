...
extern "C"
{
  ...
  extern void putset(FILE *, set *, int *, int, int, _Boolean);
  extern void putset_firstbold(FILE *, set *, int *, int, int, _Boolean);
  extern void rangraph(graph *, _Boolean, int, int, int);
  extern void rangraph2(graph *, _Boolean, int, int, int, int);
  extern void rangraph2_sg(sparsegraph *, _Boolean, int, int, int);
  extern void ranreg_sg(sparsegraph *sg, int degree, int n);
  extern void ranperm(int *, int);
  extern void readgraph(FILE *, graph *, _Boolean, _Boolean, _Boolean, int, int, int);
  extern void readgraph_sg(FILE *, sparsegraph *, _Boolean, _Boolean, int, int);
  extern void readgraph_swg(FILE *, sparsegraph *, _Boolean, _Boolean, int, int);
  extern _Boolean readinteger(FILE *, int *);
  extern _Boolean readinteger_sl(FILE *, int *);
  extern void readperm(FILE *, int *, _Boolean, int);
  extern void readptn(FILE *, int *, int *, int *, _Boolean, int);
  extern void readvperm(FILE *, int *, _Boolean, int, int *);
  extern _Boolean readstring(FILE *, char *, int);
