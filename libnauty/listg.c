...
static void
putgraphx(FILE *f, graph *g, int linelength, _Boolean triang, int m, int n)
{
    int i,curlen;
    set *pg;
...
static void
putedges(FILE *f, graph *g, _Boolean ptn, int linelength, 
         _Boolean digraph, int m, int n)
...
static void
putcgraph(FILE *f, graph *g, int linelength, _Boolean digraph, int m, int n)
...
static void
putve(FILE *f, unsigned long id, graph *g, _Boolean digraph, int m, int n)
...
static void
putbliss(FILE *f, unsigned long id, _Boolean qswitch, graph *g, int m, int n)
...
static void
putam(FILE *f, graph *g, int linelength, _Boolean space,
    _Boolean triang, int m, int n)
...
static void
putMagma(FILE *outfile, graph *g, int linelength, _Boolean digraph,
...
main(int argc, char *argv[])
{
    ...
    char *arg,sw;
    _Boolean badargs,first,digraph;
    unsigned long maxin;
    long pval1,pval2;
    _Boolean fswitch,pswitch,cswitch,dswitch;
    _Boolean aswitch,lswitch,oswitch,Fswitch;
    _Boolean Aswitch,eswitch,tswitch,qswitch;
    _Boolean sswitch,Mswitch,Wswitch,Lswitch,Eswitch;
    _Boolean bswitch,Gswitch,yswitch,Yswitch,Hswitch;
    int linelength;
