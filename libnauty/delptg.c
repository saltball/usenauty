...
static int outcode;
static _Boolean digraph,dolabel;
...
static void
search(int level, int ndel, int *del, graph *g, int m, int n, _Boolean *degok)
{
    int i;
...
main(int argc, char *argv[])
{
    ...
    FILE *infile;
    _Boolean badargs,quiet,dswitch,nswitch;
    ...
    _Boolean del[MAXN];
#else
    DYNALLSTAT(_Boolean,degok,degok_sz);
    DYNALLSTAT(_Boolean,del,del_sz);
#endif
...
#if !MAXN
        DYNALLOC1(_Boolean,degok,degok_sz,n,"delptg");
