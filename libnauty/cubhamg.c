...
static int
hase34(cubgraph cub,
       int n, int ne, int *x0, int *x1, int *why, _Boolean plus, int limit)
/* test if cub has "e34" property */
{
	edgevec v1,v2,initclass,outclass;
	int ea[4*MAXNE],eb[4*MAXNE],ec[4*MAXNE];
	_Boolean done[4*MAXNE];
	int count[MAXNE];
	int i,ii;
	int vi,nbad,pluswhy;
...
main(int argc, char *argv[])
{
        ...
        _Boolean badargs,biconn,triconn,fragment;
	_Boolean in,out,inin,inout,e34,e34plus,testing;
