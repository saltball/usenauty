...
OUTPROC feature.
   ...
   variables nooutput, and canonise (all type _Boolean) can be
...
_Boolean digraph6;               /* presence of -z */
...
static void
genextend(graph *g, int n, int *deg, _Boolean rigid)
...
{
        char *arg;
        _Boolean badargs,gotd,gotD,gotf,gotmr;
	_Boolean secret,connec1;
	char *outfilename,sw;
        int i,j,argnum;
        graph g[1];
        int deg[1];
