...
_Boolean
isautom_sg(graph *g, int *p, _Boolean digraph, int m, int n)
{
    int *d,*e;
    size_t *v;
    int i,pi,di;
...
_Boolean
cheapautom_sg(int *ptn, int level, _Boolean digraph, int n)
{
    int i,k,nnt;
...
targetcell_sg(graph *g, int *lab, int *ptn, int level, int tc_level,
       _Boolean digraph, int hint, int m, int n)
{
    int i;
...
void
put_sg(FILE *f, sparsegraph *sg, _Boolean digraph, int linelength)
{
    int *d,*e;
    int n,di;
    int i,curlen,slen;
...
distances_sg(graph *g, int *lab, int *ptn, int level, int numcells, int tvpos,
         int *invar, int invararg, _Boolean digraph, int m, int n)
{
    int *d,*e;
    int i,k,dlim,wt;
    int di;
...
adjacencies_sg(graph *g, int *lab, int *ptn, int level, int numcells,
               int tvpos, int *invar, int invararg, _Boolean digraph,
               int m, int n)
{
    int *d,*e;
    int vwt,wwt;
