...
void
readgraph(FILE *f, graph *g, _Boolean digraph, _Boolean prompt,
      _Boolean edit, int linelength, int m, int n)
{
    int v,c;
    int curlen,w;
    graph *gv;
...
void
readgraph_sg(FILE *f, sparsegraph *sg, _Boolean digraph, _Boolean prompt,
...
void
readgraph_swg(FILE *f, sparsegraph *sg, _Boolean digraph, _Boolean prompt,
             int linelength, int n)
{
    int i,j,k,vv,ww,c;
    _Boolean neg,done;
...
void
readptn(FILE *f, int *lab, int *ptn, int *numcells, _Boolean prompt, int n)
{
    int i,j;
    int c,v1,v2,m;
...
void
readperm(FILE *f, int *perm, _Boolean prompt, int n)
{
    int nv;
...
void
readvperm(FILE *f, int *perm, _Boolean prompt, int n, int *nv)
{
    int i;
    int m,c,v1,v2;
...
void
rangraph(graph *g, _Boolean digraph, int invprob, int m, int n)
{
    int i,j;
    long li;
    set *row,*col;
...
void
rangraph2(graph *g, _Boolean digraph, int p1, int p2, int m, int n)
{
    int i,j;
    long li;
    set *row,*col;
...
void
rangraph2_sg(sparsegraph *sg, _Boolean digraph, int p1, int p2, int n)
{
    int i,j,k;
    int *dd,*ee;
