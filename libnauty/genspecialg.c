...
static void
writedread(FILE *f, sparsegraph *sg, _Boolean digraph)
...
static void
makepath(long n, _Boolean digraph, sparsegraph *sg)
{
    int *d,*e,i;
    size_t *v,k;
...
static void
makecycle(long n, _Boolean digraph, sparsegraph *sg)
{
    int *d,*e,i;
    size_t *v;
...
static void
makeflowersnark(long k, _Boolean digraph, sparsegraph *sg)
...
static void
makeJohnson(long n, long k, _Boolean digraph, sparsegraph *sg)
{
    size_t *v;
...
static void
makecomplete(long n, _Boolean digraph, sparsegraph *sg)
{
    int *d,*e,i,j;
    size_t *v,k;
...
static void
makeempty(long n, _Boolean digraph, sparsegraph *sg)
{
    int *d,*e,i;
    size_t *v;
...
static void
makehypercube(long deg, _Boolean digraph, sparsegraph *sg)
{
    int *d,*e,i,j;
    size_t *v,k,nv;
...
static void
maketheta(long *len, int npaths, _Boolean digraph, sparsegraph *sg)
{
...
static void
makegrid(long *dim, int ndim, _Boolean digraph, sparsegraph *sg)
{
...
static void
makecirculant(long n, long *conn, int nconn, _Boolean digraph, sparsegraph *sg)
{
    int *d,*e,i,j,deg;
    size_t *v,k;
...
static void
makegenpetersen(long n1, long n2, _Boolean digraph, sparsegraph *sg)
{
    int *d,*e,i,n;
    size_t *v,k;
...
makecompletebipartite(long n1, long n2,
                      long matching, _Boolean digraph, sparsegraph *sg)
{
...
main(int argc, char *argv[])
{
    ...
    int argnum,j;
    char *arg,sw;
    _Boolean badargs,quiet;
    _Boolean Cswitch,Pswitch,gswitch,sswitch,zswitch,Jswitch,dswitch;
    _Boolean pswitch,cswitch,eswitch,kswitch,bswitch,Qswitch,Gswitch;
    _Boolean fswitch,Tswitch,verbose,havegraph,dreadnaut;
    long size;
    static FILE *outfile;
    char *outfilename;
    sparsegraph sg;
