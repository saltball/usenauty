...
/* How to use this as a skeleton to construct a filter.
   ...
   a procedure with prototype matching
      _Boolean
      numleaves(graph *g, _Boolean digraph, long Qlo, long Qhi, int m, int n);
...
#ifdef FILTER
extern _Boolean
FILTER(graph *g, _Boolean digraph, long Qlo, long Qhi, int m, int n);
#ifdef SUMMARY
...
main(int argc, char *argv[])
{
    ...
    char *arg,sw;
    _Boolean sswitch,fswitch,pswitch,qswitch,gswitch;
    _Boolean hswitch,xswitch,iswitch,Iswitch,zswitch;
    _Boolean badargs,digraph,vswitch,Qswitch,kept;
    long Qlo,Qhi;
