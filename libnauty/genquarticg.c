...
_Boolean     connec1;                        /* presence of -c */
_Boolean     connec2;                        /* presence of -C */
...
static void    extend(int, graph *, edgestruct *, pairstruct *, int, int * , int *, setword *, int *, _Boolean );
static int     init_refinex( int *, int *, int *, set *, int);
static void     refinex( graph *, int *, int *, int , int *, int *, set *, _Boolean , int *, int , int );
...
extend(int n, graph *g, edgestruct *edge, pairstruct *epair, int numpair,
   int *epairorbit, int *multar, setword *zar, int *col00w, _Boolean connectflag)
{
...
refinex(graph *g, int *lab, int *ptn, int level, int *numcells, int *count,
           set *active, _Boolean goodret, int *code, int m, int n)
{
...
int main(int argc, char *argv[])
{
    ...
    setword     zar[MAXN];
    _Boolean     badargs, gotf, gotmr, quiet;
    char        *arg;
    char        msg[201];
