...
main(int argc, char *argv[])
{
	...
	char *arg, sw;
	_Boolean badargs, make_ranks, too_big;
	_Boolean rswitch, dswitch, mswitch, nswitch, oswitch, iswitch, xswitch, Sswitch, gswitch, fswitch, vswitch, rswitch1, Eswitch, Vswitch;
