...
static void
gcomplement(graph *g, _Boolean loopstoo, int m, int n)
...
static void
ranedges(long e, _Boolean loopsok, graph *g, int m, int n)
...
static void
grandgraph(graph *g, _Boolean digraph, _Boolean loopsok,
...
static void
grandgraph_bip(graph *g, _Boolean digraph,
...
static void
ranarcs(long e, _Boolean loopsok, graph *g, int m, int n)
 ...
 * and return it in sg. */
{
...
#else
    DYNALLSTAT(int,cub,cub_sz);
    DYNALLSTAT(_Boolean,adj,adj_sz);
#endif
	...
	comdeg = n - degree - 1;
        ...
        DYNALLOC1(_Boolean,adj,adj_sz,n,"dmodel_sg");
#endif
   ...
   and degree deg1 on the left and return it in sg. */
{
	...
	comne = n1*(size_t)comdeg1;
        ...
        DYNALLOC1(_Boolean,adj,adj_sz,n,"dmodel_bip_sg");
#endif
...
main(int argc, char *argv[])
{
    ...
    char *arg,sw;
    _Boolean badargs;
    _Boolean gswitch,sswitch,qswitch,Sswitch,Rswitch,lswitch,tswitch;
    _Boolean aswitch,P1switch,P2switch,eswitch,rswitch,mswitch,dswitch;
    _Boolean Tswitch;
    ...
    char *outfilename;
    sparsegraph sg;
    _Boolean usesparse,digraph,bipartite;
