...
static int
trythisone(grouprec *group, graph *g, _Boolean digraph, int m, int n)
...
static int
scan(int level, graph *g, _Boolean digraph, int *prev, long minedges, long maxedges,
...
main(int argc, char *argv[])
{
    ...
    _Boolean fswitch,uswitch,eswitch,qswitch,mswitch;
