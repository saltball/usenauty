...
void
writeperm(FILE *f, int *perm, _Boolean cartesian, int linelength, int n)
{
...
maketargetcell(graph *g, int *lab, int *ptn, int level, set *tcell,
       int *tcellsize, int *cellpos, int tc_level, _Boolean digraph,
       int hint,
       int (*targetcell)(graph*,int*,int*,int,int,_Boolean,int,int,int),
       int m, int n)
{
    int i,j,k;
