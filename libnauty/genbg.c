...
OUTPROC feature.
   ...
   (all type _Boolean) can be used to test for the presence of the
...
static _Boolean connec;          /* presence of -c */
static _Boolean verbose;         /* presence of -v */
static _Boolean simple;          /* presence of -z */
...
_Boolean greout;                 /* presence of -a */
_Boolean quiet;                  /* presence of -q */
_Boolean footfree;               /* presence of -F */
_Boolean cutfree;                /* presence of -L */
_Boolean antichain;              /* presence of -A */
...
refinex(graph *g, int *lab, int *ptn, int level, int *numcells,
    int *count, set *active, _Boolean goodret,
...
static _Boolean
accept1(graph *g, int n2, int x, graph *gx, int *deg, _Boolean *rigid)
...
static _Boolean
accept2(graph *g, int n2, int x, graph *gx, int *deg, _Boolean nuniq)
...
static void
genextend(graph *g, int n2, int *deg, int ne, _Boolean rigid, int xlb, int xub)
...
{
    char *arg;
    _Boolean badargs,gotD,gote,gotf,gotmr,gotY,gotZ,gotd,gotX;
    long Dval1,Dval2;
    long dval1,dval2;
