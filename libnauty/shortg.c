...
beginsort(FILE **sortin, FILE **sortout, char *tempdir,
          _Boolean vdswitch, _Boolean keep)
...
main(int argc, char *argv[])
{
    ...
    char sw,*fmt;
    _Boolean badargs,quiet,vswitch,dswitch,kswitch,format,uswitch;
    _Boolean iswitch,Iswitch,Kswitch,Tswitch;
    _Boolean zswitch,sswitch,gswitch,Sswitch,tswitch;
    _Boolean digraph;
