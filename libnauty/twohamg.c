...
DYNALLSTAT(_Boolean,onstack,onstack_sz);
static int *top;
   ...
   e is a vector like sg.e */
{
    ...
    DYNALLOC1(_Boolean,onstack,onstack_sz,n,"malloc");
...
static _Boolean
makeblue(int edge, _Boolean lastok)
...
static _Boolean
makered(int edge, _Boolean lastok)
...
static int
p4decomposition(sparsegraph sg, int vertex, _Boolean vertical)
...
main(int argc, char *argv[])
{
    ...
    char *arg,sw;
    _Boolean badargs;
    _Boolean sswitch,gswitch,qswitch,vswitch,xswitch,Xswitch;
    _Boolean pswitch,Lswitch,tswitch,yswitch,Yswitch;
    long Lvalue;
    double t;
