...
static _Boolean Gswitch,Vswitch,ntgroup,ntisol,digraph6;
...
scan(int level, int ne, int minarcs, int maxarcs, int sofar,
    _Boolean oriented, grouprec *group, int n)
...
main(int argc, char *argv[])
{
    ...
    char *arg,sw;
    _Boolean badargs;
    _Boolean Tswitch,uswitch,eswitch,qswitch,oswitch,fswitch,sswitch;
