...
static _Boolean Gswitch,Tswitch,Aswitch,Bswitch;
static int Brows;
...
trythisone(grouprec *group,
       _Boolean lswitch, int *deg, int maxdeg, int ne, int n)
...
multi(graph *g, int nfixed, long minedges, long maxedges, long maxmult,
      int maxdeg, _Boolean lswitch, int m, int n)
{
...
main(int argc, char *argv[])
{
    ...
    char *arg,sw;
    _Boolean badargs;
    _Boolean fswitch,uswitch,eswitch,qswitch,mswitch,Dswitch;
    _Boolean lswitch,rswitch;
